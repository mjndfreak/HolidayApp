...
Console.Write(@"Ulaşım seçenekleri:
...
{
    case "bodrum":
        Console.WriteLine(@"Bodrum'un eski adı 'Halikarnassos'tur. Türkçe'de 'Halikarnassos' olarak okunmuştur.
    ...
    case "marmaris":
        Console.WriteLine(@"Marmaris'in tarihi MÖ 12000'lere kadar gider. 2007 yılında Bedir Adasındaki Nimara Mağarasında yapılan kazı çalışmaları
    ...
    case "cesme":
        ...
        Console.WriteLine(@"İlk çağda CYSUS adıyla bilinen Çeşme, Anadolu’nun batı kıyısında MÖ 1000 yıllarında kurulduğu tahmin edilen 12 İonya kentinden biri olan ERYTHRAI (ERİTRE)’nin
